...
fetch('https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics%2Cplayer&id='+video_id+'&key=AIzaSyCfWAR7c8dKE4VZNUE8NzkLkJtj-lEqeLs')
.then((res) => {
  return res.json();
}).then((data) => {
